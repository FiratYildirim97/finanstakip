export const ASSET_OPTIONS = {
  ...
  commodity: [
    ...
    { symbol: 'HAMIT', name: 'Hamit Altın' },
    { symbol: 'CUMHURIYET', name: 'Cumhuriyet Altını' },
    { symbol: '22AYAR', name: '22 Ayar Bilezik (Gram)' },
    { symbol: '18AYAR', name: '18 Ayar Altın (Gram)' },
    { symbol: '14AYAR', name: '14 Ayar Altın (Gram)' },
    { symbol: 'GREMESE', name: 'Gram Gümüş' },
    { symbol: 'XAU', name: 'ONS Altın (USD)' },
    { symbol: 'XAG', name: 'Gümüş (ONS/USD)' },
