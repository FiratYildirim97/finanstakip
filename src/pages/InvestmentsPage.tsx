  ...
  return (
    <div className="space-y-6 md:space-y-8">
      ...
      <div className="space-y-6">
        {/* Top Stats & Add Button row */}
        <div className="flex flex-col md:flex-row gap-4 sm:gap-6 w-full">
            <div className="flex-1 bento-card flex justify-between items-center">
              <div>
            ...
            <div className="flex flex-col justify-center">
              <button
                onClick={() => setQuickAddId('new_modal')}
                className="h-full px-6 py-4 bg-gradient-to-r from-[var(--color-brand-primary)]/20 to-blue-500/20 border border-[var(--color-brand-primary)]/30 text-[var(--color-brand-primary)] rounded-3xl font-bold flex flex-col items-center justify-center gap-2 hover:bg-[var(--color-brand-primary)]/30 transition-all hover:scale-[1.02] active:scale-[0.98]"
              >
                <Plus size={24} />
        ...
        {quickAddId === 'new_modal' && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/70 backdrop-blur-md" onClick={() => setQuickAddId(null)}>
            ...
            >
              <div className="p-5 border-b border-white/5 bg-gradient-to-r from-[var(--color-brand-primary)]/10 to-blue-500/10 flex justify-between items-center">
                <h3 className="font-bold text-white flex items-center gap-2 text-lg">
                  <Plus size={20} className="text-[var(--color-brand-primary)]" /> Yeni Varlık Ekle
                </h3>
              </div>
              <form onSubmit={handleManualSubmit} className="p-6 space-y-5">
                ...
                <div className="flex gap-3 pt-2">
                  ...
                  <button type="submit" onClick={() => setTimeout(() => setQuickAddId(null), 500)} className="primary-gradient-btn rounded-xl py-3 font-bold flex-[2]">
                    Yatırımı Kaydet
                  </button>
                </div>
              </form>
      ...
      <div className="space-y-6 w-full mt-6">
        <div className="bento-card p-0 overflow-hidden flex flex-col h-full w-full">
                          ...
                          <div className="text-left sm:text-right flex items-center justify-between sm:justify-end gap-5 w-full sm:w-auto mt-2 sm:mt-0">
                            ...
                            <div className="flex">
                              <button 
                                ...
                                className={`p-2.5 hover:bg-[var(--color-brand-primary)]/10 rounded-xl transition-all bg-white/5 text-white lg:text-[var(--color-text-variant)] lg:bg-transparent opacity-100 lg:opacity-0 lg:group-hover:opacity-100 focus:opacity-100 ${quickAddId === inv.id ? 'text-[var(--color-brand-primary)] opacity-100' : 'text-[var(--color-text-variant)] hover:text-[var(--color-brand-primary)]'}`}
                              >
                                <Plus size={18} />
                              </button>
                              <button 
