  ...
  return (
    <div className="space-y-8 max-w-5xl mx-auto">
      <div className="flex items-center justify-between">
         <div>
          <h1 className="text-4xl font-bold tracking-tight text-white font-display">Net Varlık (Net Worth)</h1>
      ...
      <div className="bento-card relative overflow-hidden flex flex-col justify-center min-h-[220px]">
         ...
         <h2 className="text-5xl font-black text-white font-display tracking-tight">
            {new Intl.NumberFormat('tr-TR', { style: 'currency', currency: 'TRY' }).format(currentNetWorth || 0)}
         </h2>
         <button 
            onClick={saveTodayNetWorth}
            className="mt-8 primary-gradient-btn w-fit px-8 py-3 rounded-xl flex items-center gap-2"
          >
